...
// --------------------------------------------------------
class ISimpleShader : public IResource
{
public:
...
public:
	...
	ID3D11VertexShader* GetDirectXShader()
	{
		return shader;
	}
...
public:
	...
	ID3D11PixelShader* GetDirectXShader()
	{
		return shader;
	}
...
public:
	...
	ID3D11DomainShader* GetDirectXShader()
	{
		return shader;
	}
...
public:
	...
	ID3D11HullShader* GetDirectXShader()
	{
		return shader;
	}
...
public:
	...
	ID3D11GeometryShader* GetDirectXShader()
	{
		return shader;
	}
...
public:
	...
	ID3D11ComputeShader* GetDirectXShader()
	{
		return shader;
	}
